...
# ========================== DATA LOADING (zoptymalizowane pod Cloud) ==========================
...
with tab2:
    ...
    if not selected_display:
        ...
        temp_df = df_filtered[df_filtered[player_filter_col if 'player_filter_col' in locals() else "batter_name"].isin(
            player_filter_values if 'player_filter_values' in locals() else selected_display)].copy()
...
# TAB 3, 4, 5 - wklej resztę z Twojego oryginalnego kodu (lub daj znać, to uzupełnię)
