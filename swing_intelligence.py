...
with tab_ov:
    ...
    # Data source / project attribution
    st.markdown("---")
    st.caption("**Swing Intelligence**")
    st.markdown(
        "<div style='font-size:0.72rem;color:#8b949e;line-height:1.5'>"
        "<strong>Data source:</strong> "
        "<a href='https://baseballsavant.mlb.com/' target='_blank' "
        "style='color:#8b949e;text-decoration:none'>Baseball Savant (MLB Statcast)</a> "
        "· Bat-tracking data exported to CSV and processed for this dashboard."
        "</div>",
